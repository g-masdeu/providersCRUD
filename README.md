...
- **Borrado Lógico (Soft Delete)**: Se implementó el campo `active` para permitir la "eliminación" visual de proveedores sin perder el histórico contable requerido por el departamento.
